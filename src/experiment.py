...
from src.models.KernelIVAdaptBand.trainer import KernelIVAdaptBandTrainer
...
def get_trainer(alg_name: str):
    ...
    elif alg_name == "KernelIVAdaptBand":
        return KernelIVAdaptBandTrainer
...
def experiments(alg_name: str,
    ...
    for dump_name, data_param in grid_search_dict(org_data_config):
        ...
        np.savetxt(one_save_dir.joinpath("result.csv"), np.array(res))
